...
<template>
    <Card class="w-full">
        ...
        <template #content>
                ...
                <DataView :value="props.product.accounts">
                    <template #list="prop">
                        <div class="flex flex-col gap-3">
                            <div class="flex gap-3" v-for="item in prop.items">
                                <div class="w-[100px] h-[100px]">
                                    <img
                                        alt="flag"
                                        :src="
                                            item.iso_code
                                                ? `/svg/${item.iso_code}.svg`
            ...
            >
                ...
                <div class="">
                    ...
                    <p>
                        ...
                        elit. Et praesentium architecto ea nobis sequi quibusdam
                        ullam asperiores quasi soluta eligendi mollitia alias
                        ipsum fugit delectus voluptate, recusandae corporis
                        inventore nesciunt.
                    </p>
                </div>
            </div>
            ...
            <!-- bot -->
            <div class="flex flex-col gap-4" v-if="props.product.type == 'bot'">
                <div class="flex gap-4">
                    <img src="https://dummyimage.com/150x150/000/fff" alt="" />
                    <div class="flex flex-col">
                        <h1 class="text-2xl font-bold">
